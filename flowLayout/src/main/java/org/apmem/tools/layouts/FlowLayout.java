...
public class FlowLayout extends ViewGroup {
    ...
    private final ConfigDefinition firstLineConfig;
    ...
    public FlowLayout(Context context) {
        ...
        this.firstLineConfig = new ConfigDefinition();
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            this.firstLineConfig.setOrientation(a.getInteger(R.styleable.FlowLayout_android_orientation, CommonLogic.HORIZONTAL));
            this.firstLineConfig.setDebugDraw(a.getBoolean(R.styleable.FlowLayout_debugDraw, false));
            this.firstLineConfig.setWeightDefault(a.getFloat(R.styleable.FlowLayout_weightDefault, 0.0f));
            this.firstLineConfig.setGravity(a.getInteger(R.styleable.FlowLayout_android_gravity, Gravity.NO_GRAVITY));
            this.firstLineConfig.setLayoutDirection(a.getInteger(R.styleable.FlowLayout_layoutDirection, View.LAYOUT_DIRECTION_LTR));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // ugly, but useful. 用于设置第一行末尾的偏置
        this.firstLineConfig.setMaxWidth(MeasureSpec.getSize(widthMeasureSpec) - this.getPaddingRight() - firstLineOffset);
        this.firstLineConfig.setMaxHeight(MeasureSpec.getSize(heightMeasureSpec) - this.getPaddingTop() - this.getPaddingBottom());
        this.firstLineConfig.setWidthMode(MeasureSpec.getMode(widthMeasureSpec));
        this.firstLineConfig.setHeightMode(MeasureSpec.getMode(heightMeasureSpec));
        this.firstLineConfig.setCheckCanFit(this.config.getLengthMode() != View.MeasureSpec.UNSPECIFIED);
        // 偏置
        CommonLogic.fillLines(views, lines, config, firstLineConfig);
        ...
        // 偏置
        CommonLogic.applyGravityToLines(lines, realControlLength, realControlThickness, config, firstLineConfig);
